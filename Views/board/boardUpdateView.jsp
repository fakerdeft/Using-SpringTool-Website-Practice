                ...
                <table align="center">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            현재 업로드된 파일 : <a href="${board.changeName }" download="${board.originName }">${board.originName }</a>
                        </td>
                    </tr>
                    <tr>
                        <th><label for="content">내용</label></th>
                        <td>
                        <textarea id="content" class="form-control" rows="10" style="resize:none;" name="boardContent" required>${board.boardContent }</textarea>
                        </td>
                    </tr>
                </table>
                <br>
